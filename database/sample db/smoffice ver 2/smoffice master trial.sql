...
-- Dumping data for table smoffice.areas: ~0 rows (approximately)
INSERT INTO `areas` (`id`, `branch_id`, `name`, `created_at`, `updated_at`) VALUES
	(1, 3, 'BOGOR TENGAH', '2024-05-21 13:44:48', '2024-05-21 13:45:11');

-- Dumping data for table smoffice.branches: ~0 rows (approximately)
...
-- Dumping data for table smoffice.brand_products: ~0 rows (approximately)
...
-- Dumping data for table smoffice.category_products: ~0 rows (approximately)
...
-- Dumping data for table smoffice.customers: ~0 rows (approximately)
INSERT INTO `customers` (`id`, `code`, `name`, `phone`, `photo`, `address`, `LA`, `LO`, `area_id`, `sub_area_id`, `status_registration`, `type`, `banner`, `branch_id`, `user_id`, `status`, `created_by`, `updated_by`, `deleted_by`, `created_at`, `updated_at`, `deleted_at`) VALUES
	(1, 'BGR001', 'TOMMY PLASTIK', '0813 4542 6108', 'uploads/customer//BGR001-TOMMY PLASTIK-18-Mar-2024 175405.jpg', 'PS. BABAKAN MADANG BLOK A NO: 2 SENTUL BOGOR', '-6.5639335321721', '106.86324991286', NULL, NULL, 'N', 'S', 0, 3, NULL, 1, 1, NULL, NULL, '2024-03-18 10:37:36', '2024-03-18 10:54:06', NULL),
	(2, 'BGR002', 'FERY PLASTIK', '0895 1305 0580', 'uploads/customer//BGR002-FERY PLASTIK-19-Mar-2024 053545.jpg', 'JL. H. MAWI RT 03/03 GG. M. AL ISLAH KP. JATI PARUNG', '-6.4272866666667', '106.724525', NULL, NULL, 'N', 'S', 0, 3, NULL, 1, 1, NULL, NULL, '2024-03-18 10:37:36', '2024-03-18 22:35:45', NULL),
	(3, 'BGR003', 'MY PLASTIK', '0831 4375 6198', 'uploads/customer//BGR003-MY PLASTIK-19-Mar-2024 055623.jpg', 'JL. CIKOPO SELATAN KP. SUKABIRUS ATAS RT 01/03 KEL. SUKAMAHI', '-6.6557750449496', '106.86184477061', NULL, NULL, 'N', 'S', 0, 3, NULL, 1, 1, NULL, NULL, '2024-03-18 10:37:36', '2024-03-18 22:56:23', NULL),
	(4, 'BGR004', 'LARAS PLASTIK', '0838 1542 8935', 'uploads/customer//BGR004-LARAS PLASTIK-19-Mar-2024 055959.jpg', 'JL. MA SALMUN BLOK B 15 PS. ANYAR BOGOR', '-6.5898290346182', '106.79192963988', NULL, NULL, 'N', 'S', 0, 3, NULL, 1, 1, NULL, NULL, '2024-03-18 10:37:36', '2024-03-18 22:59:59', NULL),
	(5, 'BGR005', 'MURNI PLASTIK', '0813-1251-3322', 'uploads/customer//BGR005-MURNI PLASTIK-19-Mar-2024 113017.jpeg', 'KP. CUKANG GALEUH RT.05/05 KM.14 DESA CIHERANG', '-6.6873609756587', '106.82576201856', NULL, NULL, 'N', 'S', 0, 3, NULL, 1, 1, NULL, NULL, '2024-03-18 10:37:36', '2024-03-19 04:30:18', NULL),
	(6, 'BGR006', 'MITRA JAYA II', '0812-7396-4830', NULL, 'PS. CISALAK JL. H. UHON DEPOK', '-6.3785585678908', '106.86663988978', NULL, NULL, 'N', 'S', 0, 3, NULL, 1, 1, NULL, NULL, '2024-03-18 10:37:36', '2024-03-18 10:37:36', NULL),
	(7, 'BGR007', 'TUNAS MANDIRI', '0857 7833 9066', NULL, 'JL. RAYA CIDAHU PONDOKOSO TONGGOH', '-6.7992460786865', '106.75887577236', NULL, NULL, 'N', 'S', 0, 3, NULL, 1, 1, NULL, NULL, '2024-03-18 10:37:36', '2024-03-18 10:37:36', NULL),
	(8, 'BGR008', 'RAMDAN PLASTIK TOKO', '0888 0918 7835', NULL, 'JL. RAYA CIANJUR - SUKABUMI KM.14 PS.GEKBRONG KEC.GEKBRONG KEL.GEKBRONG KAB.CIANJUR (DEKAT TOKO MACI)', '-6.8674697982354', '107.03270349652', NULL, NULL, 'N', 'S', 0, 3, NULL, 1, 1, NULL, NULL, '2024-03-18 10:37:36', '2024-03-18 10:37:36', NULL),
	(9, 'BGR009', 'LANI, TOKO', '0812 9087 8763', NULL, 'JL. LAYUNG SARI 1 EMPANG BOGOR SELATAN', '-6.5911326336936', '106.79257772863', 1, 1, 'Y', 'S', 0, 3, NULL, 1, 1, 1, NULL, '2024-03-18 10:37:36', '2024-05-21 13:51:27', NULL),
	(10, 'BGR0010', 'CHA CHA BAHAN KUE', '0812 9897 4327', 'uploads/customer//BGR0010-CHA CHA BAHAN KUE-20-Mar-2024 153555.jpg', 'RUKO 8 JL.RAYA PEMDA KARADENAN RT.003 RW.010 NO.1 KEC.CIBINONG KEL.KARADENAN KAB.BOGOR 16913', '-6.5116051781705', '106.8067850545', NULL, NULL, 'N', 'S', 0, 3, NULL, 1, 1, NULL, NULL, '2024-03-18 10:37:36', '2024-03-20 08:35:56', NULL),
	...
	(12, 'BGR0010', 'TOKO PLASTIK BARU 2', NULL, 'uploads/customer//BGR0010-TOKO PLASTIK BARU 2-28-Mar-2024 140330.jpg', NULL, '-6.1494295', '106.7116815', NULL, NULL, 'N', 'S', 0, 3, NULL, 1, 1, 1, NULL, '2024-03-18 10:37:36', '2024-04-04 09:27:01', NULL),
	...
	(15, 'BGR0010', 'Geoffrey Forbes', '+1 (802) 804-4455', NULL, 'Maiores voluptas off', '52', '43', NULL, NULL, 'N', 'S', 0, 3, NULL, 1, 1, NULL, NULL, '2024-03-18 10:37:36', '2024-03-18 10:37:36', NULL),
	(16, 'BGR0010', 'Martabak Jakarta', '+1 (295) 436-1993', 'uploads/customer//BGR0010-Martabak Jakarta-19-Mar-2024 114435.jpg', 'Deleniti autem commo', '14', '43', 1, 1, 'Y', 'O', 0, 3, NULL, 1, 1, 1, NULL, '2024-03-18 10:39:19', '2024-05-21 13:59:20', NULL),
	(17, 'BGR0010', 'Martabak Bangka', '0813 4542 6108', 'uploads/customer//BGR0010-Martabak Bangka-19-Mar-2024 113814.jpg', 'PS. BABAKAN MADANG BLOK A NO: 2 SENTUL BOGOR', '-6.5639335321721', '106.86324991286', NULL, NULL, 'Y', 'O', 0, 3, NULL, 1, 1, NULL, NULL, '2024-03-18 10:39:19', '2024-03-28 03:30:47', NULL),
	...
	(20, 'Et aut amet pariatu', 'Ebony Dickson', '+1 (709) 283-3804', NULL, 'Aliquam aut nisi cup', '2', '86', NULL, NULL, 'Y', 'O', 1, 1, NULL, 1, 1, NULL, NULL, '2024-04-04 04:35:09', '2024-04-04 04:35:09', NULL),
	(21, 'JKT002', 'Eagan Head', '+1 (232) 511-2037', NULL, 'Amet illum accusam', '57', '29', NULL, NULL, 'N', 'O', 1, 1, NULL, 1, 1, NULL, NULL, '2024-04-04 04:36:47', '2024-04-04 04:36:47', NULL),
	(22, 'JKT003', 'Minerva Craig', '+1 (845) 625-2408', NULL, 'Quia aut sunt dolore', '29', '55', NULL, NULL, 'Y', 'O', 1, 1, NULL, 1, 1, NULL, NULL, '2024-04-04 04:37:03', '2024-04-04 04:37:03', NULL),
	(23, 'JKT004', 'Lael Ortiz', '+1 (987) 591-6309', NULL, 'Amet dolor vero ali', '51', '3', NULL, NULL, 'N', 'O', 0, 1, NULL, 1, 1, NULL, NULL, '2024-04-04 04:38:41', '2024-04-04 04:38:41', NULL),
	(24, 'Offi"cia consectetur', 'Dora Sawyer', '+1 (194) 265-5862', 'uploads/customer//Offi\'cia consectetur-Dora Sawyer-05-Apr-2024 100459.jpg', 'Omnis repudiandae ei', '61', '38', NULL, NULL, 'Y', 'O', 0, 1, NULL, 1, 1, NULL, NULL, '2024-04-05 03:03:36', '2024-04-05 03:04:59', NULL),
	(25, 'Quis et neque volupt', 'Arsenio - Grant', '+1 (316) 871-7376', NULL, 'Rem voluptas totam i', '82', '97', NULL, NULL, 'Y', 'O', 0, 1, NULL, 1, 1, NULL, NULL, '2024-04-05 07:14:36', '2024-04-05 07:14:36', NULL),
	(26, 'Ex autem totam dolor', 'Hyacinth\'Burt', '+1 (957) 369-6491', 'uploads/customer//Ex autem totam dolor--05-Apr-2024 141621.jpg', 'Veniam perferendis', '97', '36', NULL, NULL, 'N', 'O', 1, 3, NULL, 1, 1, NULL, NULL, '2024-04-05 07:14:58', '2024-04-05 07:16:21', NULL);

-- Dumping data for table smoffice.display_products: ~0 rows (approximately)
...
-- Dumping data for table smoffice.fotos: ~0 rows (approximately)

-- Dumping data for table smoffice.moduls: ~0 rows (approximately)
INSERT INTO `moduls` (`id`, `name`, `view`, `detail`, `create`, `edit`, `delete`, `export`, `import`, `created_by`, `updated_by`, `created_at`, `updated_at`) VALUES
	...
	(15, 'area', 1, 1, 1, 1, 1, 0, 0, 1, NULL, '2024-05-21 13:43:55', '2024-05-21 13:43:55'),
	(16, 'sub_area', 1, 1, 1, 1, 1, 0, 0, 1, NULL, '2024-05-21 13:44:08', '2024-05-21 13:44:08');

-- Dumping data for table smoffice.owners: ~0 rows (approximately)
...
-- Dumping data for table smoffice.permissions: ~0 rows (approximately)
INSERT INTO `permissions` (`id`, `name`, `guard_name`, `created_at`, `updated_at`) VALUES
	...
	(74, 'area view', 'web', '2024-05-21 13:43:55', '2024-05-21 13:43:55'),
	(75, 'area detail', 'web', '2024-05-21 13:43:55', '2024-05-21 13:43:55'),
	(76, 'area create', 'web', '2024-05-21 13:43:55', '2024-05-21 13:43:55'),
	(77, 'area edit', 'web', '2024-05-21 13:43:55', '2024-05-21 13:43:55'),
	(78, 'area delete', 'web', '2024-05-21 13:43:55', '2024-05-21 13:43:55'),
	(79, 'sub_area view', 'web', '2024-05-21 13:44:08', '2024-05-21 13:44:08'),
	(80, 'sub_area detail', 'web', '2024-05-21 13:44:09', '2024-05-21 13:44:09'),
	(81, 'sub_area create', 'web', '2024-05-21 13:44:09', '2024-05-21 13:44:09'),
	(82, 'sub_area edit', 'web', '2024-05-21 13:44:09', '2024-05-21 13:44:09'),
	(83, 'sub_area delete', 'web', '2024-05-21 13:44:09', '2024-05-21 13:44:09');

-- Dumping data for table smoffice.positions: ~0 rows (approximately)
...
-- Dumping data for table smoffice.products: ~0 rows (approximately)
...
-- Dumping data for table smoffice.roles: ~0 rows (approximately)
...
-- Dumping data for table smoffice.sub_areas: ~0 rows (approximately)
INSERT INTO `sub_areas` (`id`, `branch_id`, `area_id`, `name`, `created_at`, `updated_at`) VALUES
	(1, 3, 1, 'CIBINONG', '2024-05-21 13:45:26', '2024-05-21 13:45:26');

-- Dumping data for table smoffice.sub_brand_products: ~0 rows (approximately)
...
-- Dumping data for table smoffice.unproductive_reasons: ~0 rows (approximately)
...
-- Dumping data for table smoffice.users: ~0 rows (approximately)
