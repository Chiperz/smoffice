...
class SummaryByBranchDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            // ->addColumn('store_regist', function($query){
            //     return $query->customer()->where(['type' => 'S', 'status_registration' => 'Y'])->count();
            // })
    ...
    {
        return $this->builder()
                    ->setTableId('summarybybranch-table')
    ...
    {
        return 'SummaryByBranch_' . date('YmdHis');
    }
}
